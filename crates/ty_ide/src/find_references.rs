...
",
    ...
    #[test]
    fn deferred_annotation_load_uses_end_of_scope_provider() {
        let test = cursor_test(
            r#"
class First: ...
value: Fir<CURSOR>st
...
",
    ...
    #[test]
    fn references_use_definitions_that_reach_the_selected_load() {
        let test = cursor_test(
            "
def test(flag: bool):
    if flag:
...
",
    ...
    #[test]
    fn references_respect_shadowing_before_redeclaration() {
        let test = cursor_test(
            r#"
def test(flag: bool):
    if flag:
...
"#,
    ...
    #[test]
    fn references_respect_shadowing_after_redeclaration() {
        let test = cursor_test(
            r#"
def test(flag: bool):
    if flag:
...
"#,
    ...
    #[test]
    fn references_from_bindings_are_directional() {
...
",
    ...
    #[test]
    fn references_from_loads_include_only_their_providers() {
        let test = cursor_test(
            "
if flag:
    x = 1
...
",
    ...
    #[test]
    fn references_from_loads_include_structural_references_to_their_providers() {
...
",
    ...
    #[test]
    fn without_declaration_on_bare_annotation_uses_lexical_fallback() {
        let test = cursor_test(
            "
x<CURSOR>: int
x = 1
